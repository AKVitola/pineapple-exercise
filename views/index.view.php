        ...
        <div class="mobile-page-container">
          <section class="subscripion-container mobile">
            ...
            <form novalidate action="../functionality" method="post" onsubmit="fullValidation()">
              ...
              <button id="button" class="form-arrow-btn" type="submit" name="submit" value="subscribe">
              ...
              <div class="checkbox-wrap">
                <label>
                  <input id="js-checkbox" type="checkbox" name="terms" value="terms" required onchange="fullValidation()" />
